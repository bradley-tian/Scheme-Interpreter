...
(define (enumerate s)
  ; BEGIN PROBLEM 15
  (define (tracker lst n)
    (if (null? lst) lst
    (cons (cons n (cons (car lst) nil)) (tracker (cdr lst) (+ n 1)))
    )
  )
  (tracker s 0)
)
...
(define (merge inorder? list1 list2)
  ...
  (cond
    ...
    ((= (car list1) (car list2)) (cons (car list1) (cons (car list2) (merge inorder? (cdr list1) (cdr list2)))))
